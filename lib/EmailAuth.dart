...
Future<bool> _isValidServer(String url) async {
  try {
    ...
    http.Response _serverResponse = await http.get(Uri.parse("https://csci6221.herokuapp.com/test/dart"));
  ...
  Future<bool> sendOtp(
    ...
    try {
      ...
      if (this._server.isEmpty) {
        ...
        http.Response _response = await http.get(Uri.parse(
            "https://csci6221.herokuapp.com/dart/auth/$recipientMail?CompanyName=${this.sessionName}&key=${this._serverKey}&otpLength=$otpLength"));
        return _convertData(_response, recipientMail);
      }
      return false;
    } catch (error) {
